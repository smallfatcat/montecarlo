export const CONFIG = {
    ...
    ui: {
        defaultView: 'flat',
        enableFaceImages: false, // when true, attempts to load /face/<suit>_<rank>.png
    },
    rules: {
        dealerHitsSoft17: false, // S17 by default; set true for H17
        blackjackPayout: 1.5, // 3:2 default; set 1.2 for 6:5 or 1.0 for 1:1
        doubleTotals: [], // [] means allow any two-card double; otherwise restrict to these hard totals (e.g., [10, 11])
        doubleAfterSplit: true, // DAS allowed by default
        allowSplitRanks: null, // null = allow any true pair; otherwise restrict to listed ranks
    },
};
